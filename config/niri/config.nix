...
in
{
  xdg.configFile."niri/config.kdl".text = ''
    ...
    // --- Startup handled by Systemd ---
    // (See home.nix for swaybg and quickshell services)
    ...
    binds {
        ...
        Mod+Shift+S { spawn "sh" "-c" "grim -g \"$(slurp)\" /home/barthmalemew/Pictures/Screenshots/Screenshot_$(date +'%Y-%m-%d_%H-%M-%S').png"; }
