...
ShapePath {
    ...
    property real startOffset: hasStartHug ? Size.borderRadiusLarge + 4 : Size.borderRadiusLarge
    property real endOffset: hasEndHug ? Size.borderRadiusLarge + 4 : Size.borderRadiusLarge
